...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-paper">
      ...
      <div className="min-w-0 max-w-full overflow-x-hidden md:pl-64">
        ...
        <main className="min-w-0 max-w-full overflow-x-hidden px-4 pb-28 pt-6 md:px-8 md:pb-8">{children}</main>
      </div>
